...
public class ItemAdapter<T extends ItemAdapter.ItemHolder>
    ...
    private final OnItemClickedListener mOnItemClickedListener = new OnItemClickedListener() {
        @Override
        public void onItemClicked(ItemViewHolder<?> viewHolder, @ClickActionId int id) {
            final OnItemClickedListener listener = mListenersByViewType.get(viewHolder.getItemViewType());
            if (listener != null) {
     ...
     */
    public static abstract class ItemHolder<T extends Item> {
    ...
    public static abstract class ItemViewHolder<T extends ItemHolder> extends RecyclerView.ViewHolder {
         ...
         * @param itemHolder the {@link ItemHolder} to bind
         */
        abstract protected void onBindItemView(T itemHolder);
         ...
         */
        abstract protected void onRecycleItemView();

        abstract protected ItemAdapter.ItemViewHolder.Factory getViewHolderFactory();
         ...
         */
        public final void notifyItemClicked(@OnItemClickedListener.ClickActionId int id) {
    ...
    public interface OnItemClickedListener {
        ...
        @IntDef({ACTION_ID_COLLAPSED_VIEW, ACTION_ID_EXPANDED_VIEW})
        @interface ClickActionId {
        }

        int ACTION_ID_COLLAPSED_VIEW = 0;
        int ACTION_ID_EXPANDED_VIEW = 1;
         ...
         * @param id         the unique identifier for the click action that has occurred. One of the following values:
         *                   <ul>
         *                   <li>{@link #ACTION_ID_COLLAPSED_VIEW}: when the clicked view is the collapsed one</li>
         *                   <li>{@link #ACTION_ID_EXPANDED_VIEW}: when the clicked view is the expanded one</li>
         *                   </ul>
         */
        void onItemClicked(ItemViewHolder<?> viewHolder, @ClickActionId int id);
    }
}